...
var slideIndexprocessCarousel = "special statement";

   console.log(slideIndexprocessCarousel);

   (showDivs(slideIndexprocessCarousel, 'processCarousel'));
var slideIndexsuggestionCarousel = "special statement";

   console.log(slideIndexsuggestionCarousel);

   (showDivs(slideIndexsuggestionCarousel, 'suggestionCarousel'));
