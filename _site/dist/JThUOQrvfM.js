...
var slideIndexdes-sys-Carousel = "special statement";

   console.log(slideIndexdes-sys-Carousel);

   (showDivs(slideIndexdes-sys-Carousel, 'des-sys-Carousel'));
var slideIndexscreensCarousel = "special statement";

   console.log(slideIndexscreensCarousel);

   (showDivs(slideIndexscreensCarousel, 'screensCarousel'));
var slideIndexrepayment-plan-Carousel = "special statement";

   console.log(slideIndexrepayment-plan-Carousel);

   (showDivs(slideIndexrepayment-plan-Carousel, 'repayment-plan-Carousel'));
var slideIndexrepaymentCarousel = "special statement";

   console.log(slideIndexrepaymentCarousel);

   (showDivs(slideIndexrepaymentCarousel, 'repaymentCarousel'));
var slideIndexmaintenance-Carousel = "special statement";

   console.log(slideIndexmaintenance-Carousel);

   (showDivs(slideIndexmaintenance-Carousel, 'maintenance-Carousel'));
