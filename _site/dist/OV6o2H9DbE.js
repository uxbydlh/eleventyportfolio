...
var slideIndexmoodboardCarousel = "special statement";

   console.log(slideIndexmoodboardCarousel);

   (showDivs(slideIndexmoodboardCarousel, 'moodboardCarousel'));
var slideIndexinspoCarousel = "special statement";

   console.log(slideIndexinspoCarousel);

   (showDivs(slideIndexinspoCarousel, 'inspoCarousel'));
var slideIndexvermisCarousel = "special statement";

   console.log(slideIndexvermisCarousel);

   (showDivs(slideIndexvermisCarousel, 'vermisCarousel'));
var slideIndexchimeraCarousel = "special statement";

   console.log(slideIndexchimeraCarousel);

   (showDivs(slideIndexchimeraCarousel, 'chimeraCarousel'));
var slideIndexwireCarousel = "special statement";

   console.log(slideIndexwireCarousel);

   (showDivs(slideIndexwireCarousel, 'wireCarousel'));
var slideIndexprotoCarousel = "special statement";

   console.log(slideIndexprotoCarousel);

   (showDivs(slideIndexprotoCarousel, 'protoCarousel'));
var slideIndexfinalCarousel = "special statement";

   console.log(slideIndexfinalCarousel);

   (showDivs(slideIndexfinalCarousel, 'finalCarousel'));
