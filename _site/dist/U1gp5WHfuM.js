...
console.logMeet the Team
console.logVolunteer with Us
console.logGet Assessed
console.logOur Tutors
console.logBecome a Tutor
console.log
console.logAdenydd
/*=============== SHOW MENU ===============*/
...
document.addEventListener("adobe_dc_view_sdk.ready", function(){ 
		var adobeDCView = new AdobeDC.View({clientId: "2e45665c31ec4cf5b22c18d63cdebf2a", divId: "adobe-pdf-view"});
		adobeDCView.previewFile({
			content:{location: {url: "http://localhost:8080/assets/pdf/PLI-certificate.pdf"}},
			metaData:{fileName: "PLI-certificate.pdf"}
		}, {
			embedMode: "IN_LINE"
		});
	});
