...
var slideIndexoldNewFlowCarousel = "special statement";

   console.log(slideIndexoldNewFlowCarousel);

   (showDivs(slideIndexoldNewFlowCarousel, 'oldNewFlowCarousel'));
var slideIndexcomparisonCarousel = "special statement";

   console.log(slideIndexcomparisonCarousel);

   (showDivs(slideIndexcomparisonCarousel, 'comparisonCarousel'));
...
var slideIndexbrandingCarousel = "special statement";

   console.log(slideIndexbrandingCarousel);

   (showDivs(slideIndexbrandingCarousel, 'brandingCarousel'));
var slideIndexcomponentCarousel = "special statement";

   console.log(slideIndexcomponentCarousel);

   (showDivs(slideIndexcomponentCarousel, 'componentCarousel'));
