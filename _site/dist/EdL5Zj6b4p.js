...
var potentialDropdowns = document.querySelectorAll("nav.toc ol li");
    var headsWithKids = new NodeList();
	console.log("hello world")
	console.log(potentialDropdowns);
    potentialDropdowns.forEach(element => {
        if(element.children.length <= 1){
            potentialDropdowns.remove(element);
        }
    });
    console.log("PRINTING ITEMS WITH CHILD LISTS");
    console.log(headsWithKids);
