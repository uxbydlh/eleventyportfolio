...
var slideIndexcompletedCarousel = "special statement";

   console.log(slideIndexcompletedCarousel);

   (showDivs(slideIndexcompletedCarousel, 'completedCarousel'));
var slideIndexinitialCarousel = "special statement";

   console.log(slideIndexinitialCarousel);

   (showDivs(slideIndexinitialCarousel, 'initialCarousel'));
