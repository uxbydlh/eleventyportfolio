...
var slideIndexproblem-Carousel = "special statement";

   console.log(slideIndexproblem-Carousel);

   (showDivs(slideIndexproblem-Carousel, 'problem-Carousel'));
var slideIndexresearchCarousel = "special statement";

   console.log(slideIndexresearchCarousel);

   (showDivs(slideIndexresearchCarousel, 'researchCarousel'));
var slideIndexideationCarousel = "special statement";

   console.log(slideIndexideationCarousel);

   (showDivs(slideIndexideationCarousel, 'ideationCarousel'));
var slideIndexcolour-Carousel = "special statement";

   console.log(slideIndexcolour-Carousel);

   (showDivs(slideIndexcolour-Carousel, 'colour-Carousel'));
var slideIndexlibrary-Carousel = "special statement";

   console.log(slideIndexlibrary-Carousel);

   (showDivs(slideIndexlibrary-Carousel, 'library-Carousel'));
var slideIndexscreenCarousel = "special statement";

   console.log(slideIndexscreenCarousel);

   (showDivs(slideIndexscreenCarousel, 'screenCarousel'));
