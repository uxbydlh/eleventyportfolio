...
var slideIndexasistobeCarousel = "special statement";

   console.log(slideIndexasistobeCarousel);

   (showDivs(slideIndexasistobeCarousel, 'asistobeCarousel'));
...
var slideIndexppdCarousel = "special statement";

   console.log(slideIndexppdCarousel);

   (showDivs(slideIndexppdCarousel, 'ppdCarousel'));
var slideIndexinterspersedCarousel = "special statement";

   console.log(slideIndexinterspersedCarousel);

   (showDivs(slideIndexinterspersedCarousel, 'interspersedCarousel'));
var slideIndexmicroCarousel = "special statement";

   console.log(slideIndexmicroCarousel);

   (showDivs(slideIndexmicroCarousel, 'microCarousel'));
